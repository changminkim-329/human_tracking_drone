...
input_image = Input(shape=(set.IMAGE_H, set.IMAGE_W, 3))
...
# Layer 23
x = Conv2D(set.BOX * (4 + 1 + set.CLASS), (1,1), strides=(1,1), padding='same', name='conv_23')(x)
output = Reshape((set.GRID_H, set.GRID_W, set.BOX, 4 + 1 + set.CLASS))(x)
